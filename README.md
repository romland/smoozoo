...
# Tauri + Vanilla
Intending to create a stand-alone app from this.

This template start with Tauri in vanilla HTML, CSS and Javascript.
...
npm run tauri add dialog  <- not sure if this is needed!
npm install @tauri-apps/plugin-dialog <- this finally got the darn dialog
npm install @tauri-apps/plugin-window
npm install @tauri-apps/plugin-event
...
---
   Compiling app v0.1.0 (/home/romland/development/smoozoo/src-tauri)
warning: app@0.1.0: Compiler family detection failed due to error: ToolNotFound: failed to find tool "clang-cl": No such file or directory (os error 2)
warning: app@0.1.0: Compiler family detection failed due to error: ToolNotFound: failed to find tool "clang-cl": No such file or directory (os error 2)
error: failed to run custom build command for `app v0.1.0 (/home/romland/development/smoozoo/src-tauri)`

Caused by:
  process didn't exit successfully: `/home/romland/development/smoozoo/src-tauri/target/release/build/app-f9b0dd41c31e63e4/build-script-build` (exit status: 1)
  --- stdout
  cargo:rerun-if-env-changed=TAURI_CONFIG
  cargo:rustc-check-cfg=cfg(desktop)
  cargo:rustc-cfg=desktop
  cargo:rustc-check-cfg=cfg(mobile)
  cargo:rerun-if-changed=/home/romland/development/smoozoo/src-tauri/tauri.conf.json
  cargo:rustc-env=TAURI_ANDROID_PACKAGE_NAME_APP_NAME=dev
  cargo:rustc-env=TAURI_ANDROID_PACKAGE_NAME_PREFIX=com_smoozoo_romland
  cargo:rustc-check-cfg=cfg(dev)
  cargo:PERMISSION_FILES_PATH=/home/romland/development/smoozoo/src-tauri/target/x86_64-pc-windows-msvc/release/build/app-93bd8205e29c7a9b/out/app-manifest/__app__-permission-files
  cargo:rerun-if-changed=capabilities
  cargo:rerun-if-env-changed=REMOVE_UNUSED_COMMANDS
  cargo:rustc-env=TAURI_ENV_TARGET_TRIPLE=x86_64-pc-windows-msvc
  package.metadata does not exist
  OPT_LEVEL = Some(3)
  OUT_DIR = Some(/home/romland/development/smoozoo/src-tauri/target/x86_64-pc-windows-msvc/release/build/app-93bd8205e29c7a9b/out)
  ...
  cargo:warning=Compiler family detection failed due to error: ToolNotFound: failed to find tool "clang-cl": No such file or directory (os error 2)
  ...
  CFLAGS_x86_64_pc_windows_msvc = Some(--target=x86_64-pc-windows-msvc -Wno-unused-command-line-argument -fuse-ld=lld-link /imsvc/home/romland/.cache/cargo-xwin/xwin/crt/include /imsvc/home/romland/.cache/cargo-xwin/xwin/sdk/include/ucrt /imsvc/home/romland/.cache/cargo-xwin/xwin/sdk/include/um /imsvc/home/romland/.cache/cargo-xwin/xwin/sdk/include/shared  )
  cargo:rerun-if-env-changed=CC_SHELL_ESCAPED_FLAGS
  CC_SHELL_ESCAPED_FLAGS = None
  cargo:rerun-if-env-changed=CFLAGS_x86_64-pc-windows-msvc
  CFLAGS_x86_64-pc-windows-msvc = None
  CARGO_ENCODED_RUSTFLAGS = Some(-Clinker-flavor=lld-link-Lnative=/home/romland/.cache/cargo-xwin/xwin/crt/lib/x86_64-Lnative=/home/romland/.cache/cargo-xwin/xwin/sdk/lib/um/x86_64-Lnative=/home/romland/.cache/cargo-xwin/xwin/sdk/lib/ucrt/x86_64)
  cargo:warning=Compiler family detection failed due to error: ToolNotFound: failed to find tool "clang-cl": No such file or directory (os error 2)

  --- stderr


  error occurred in cc-rs: failed to find tool "clang-cl": No such file or directory (os error 2)
